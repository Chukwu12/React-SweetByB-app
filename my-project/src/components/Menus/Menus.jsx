        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {MenusData.map((menu) => (
            ...
            >
              ...
              <div className="w-[120px] h-[200px] overflow-hidden flex justify-center items-center rounded-2xl">
                <img
                  src={menu.img}
                  alt={menu.title}
              ...
              <div className="flex justify-center items-center flex-col text-center px-2">
                <h1 className="text-md font-bold">{menu.title}</h1>
